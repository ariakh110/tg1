...
### مهاجرت اسلاگ لندینگ‌ها

هر تغییر حروف یا اسلاگ یک لندینگ ایندکس‌پذیر باید با ریدایرکت دائمی یک‌مرحله‌ای به URL canonical همراه باشد. در مهاجرت ST52، مسیر قدیمی `/category/sheet/ST52` و نسخه دارای اسلش انتهایی آن با حفظ query string به `/category/sheet/st52` منتقل می‌شوند؛ فقط نسخه lowercase در sitemap و لینک‌های داخلی باقی می‌ماند.
...
- مسیر قدیمی ST52 دقیقاً پاسخ 301 بدهد و مستقیماً به canonical lowercase برسد.
